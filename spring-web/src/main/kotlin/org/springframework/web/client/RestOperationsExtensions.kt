...
/**
 * Extension for [RestOperations.queryForObject] providing a `queryForObject<Foo>(...)`
 * variant leveraging Kotlin reified type parameters. Like the original Java method, this
 * extension is subject to type erasure. Use [exchange] if you need to retain actual
 * generic type arguments.
 *
 ...
 */
@Throws(RestClientException::class)
inline fun <reified T> RestOperations.queryForObject(url: String, request: Any? = null,
													vararg uriVariables: Any): T =
	queryForObject(url, request, T::class.java, *uriVariables) as T
 ...
 */
@Throws(RestClientException::class)
inline fun <reified T> RestOperations.queryForObject(url: URI, request: Any? = null): T =
	queryForObject(url, request, T::class.java) as T

/**
 * Extension for [RestOperations.queryForEntity] providing a `queryForEntity<Foo>(...)`
 * variant leveraging Kotlin reified type parameters. Like the original Java method, this
 * extension is subject to type erasure. Use [exchange] if you need to retain actual
 * generic type arguments.
 *
 ...
 */
@Throws(RestClientException::class)
inline fun <reified T> RestOperations.queryForEntity(url: String, request: Any? = null,
													vararg uriVariables: Any): ResponseEntity<T> =
	queryForEntity(url, request, T::class.java, *uriVariables)
 ...
 */
@Throws(RestClientException::class)
inline fun <reified T> RestOperations.queryForEntity(url: URI, request: Any? = null): ResponseEntity<T> =
	queryForEntity(url, request, T::class.java)
